                        ...
                        <nav className="navbar navbar-expand-lg navbar-light bg-light nav-content ">
                            <div className="container">
                                <NavLink className="navbar-brand " to="/Home" > 
                                    <img src={logo} alt="logo not found" width="35" height="25"></img>
                                    <Translation>
                                        {
                                            t => <span className='doctor-name'> 
                                            {
                                                t('LogoNavName')
                                            }
                                            </span> 
                                ...
                                <div className={this.state.show ? 'collapse navbar-collapse ul-nav-content' : 'collapse navbar-collapse active ul-nav-content'} >
                                    ...
                                    <ul className="navbar-nav ms-auto ">
                                        ...
                                        <Translation>
                                            {
                                                t => <li className="nav-item">
                                                    <NavLink to="/Services" className="nav-link navbar-link" >
                                                        {t('LiNavLinkServices')}
                                                    </NavLink>
                                                </li>
                                            }
